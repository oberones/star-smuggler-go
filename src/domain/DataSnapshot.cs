...
public sealed class DataSnapshot
{
    ...
    public IReadOnlyList<ShipUpgradeDefinition> Upgrades { get; init; } = new List<ShipUpgradeDefinition>();
    ...
    public IReadOnlyDictionary<string, ShipUpgradeDefinition> UpgradesById { get; init; } = new Dictionary<string, ShipUpgradeDefinition>();
}
